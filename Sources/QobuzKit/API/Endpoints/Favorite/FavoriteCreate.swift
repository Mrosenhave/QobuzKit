...
extension QobuzAPI.Endpoints {
  /**
   ...
   - Parameter albumIds: album ids to add as favorite
   - Parameter articleIds: article  ids to add as favorite
   - Parameter artistIds: artist ids to add as favorite
   - Parameter trackIds: track ids to add as favorite
   
   - Returns: A QBStatus object.
  */
  public struct FavoriteCreate: Endpoint {
    public init(
      albumIds: String...,
      articleIds: String...,
      artistIds: Int...,
    ...
    public let path: String = "favorite/create"
