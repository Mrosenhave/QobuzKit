...
extension QobuzAPI.Endpoints {
  /**
   Return the favorite status of an item related to a user.
   ...
   - Returns: A QBStatusBool object.
  */
  public struct FavoriteStatus: Endpoint {
    public init(
      itemId: String,
      type: favoriteType
    ) {
    ...
    public let path: String = "favorite/status"
