//
//  TrackReportStreamingStart.swift
//  QobuzKit
//
...
extension QobuzAPI.Endpoints {
  /**
   Report the start of the streaming of a track.
  ...
  */
  public struct TrackReportStreamingStart: Endpoint {
    /// Single report
    public init(
      appSecret: String,
      userId: String,
      ...
      let report = QBTrackReport(userId: userId, trackId: trackId, formatId: format.rawValue, date: date, duration: 0, online: online, local: local, deviceId: deviceId, credentialId: credentialId, intent: intent?.rawValue, purchase: purchase, sample: sample)
    ...
    public let path: String = "track/reportStreamingStart"
