...
extension QobuzAPI.Endpoints {
  /**
  Return the releases for an artist
   ...
   - Returns: A QBHasMoreItems\<QBArtistRelease\> object
  */
  public struct ArtistGetReleasesGrid: Endpoint {
    public init(
      artistId: Int,
    ...
    public let path: String = "artist/getReleasesGrid"
